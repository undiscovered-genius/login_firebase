...
# Email Sign-in Screen
  IF user have already created an account then he/she can directly login with there email & password. One can even change the password if they forgot.
<img src = "" width="300">
<img src = "" width="300">

# Phone Sign-in Screen 
  User can simply login throught mobile number. A OTP will be generated after entering the mobile number, which the user will recieve within few seconds. App will automatically take the OTP as soon as it comes and after checking, it will forward the user to his/her profile. 
<img src = "app\src\main\res\drawable-v24\Screenshot_phomeLogin.png" width="300">
<img src = "app\src\main\res\drawable-v24\Screenshot_phoneOTP1.png" width="300">
<img src = "app\src\main\res\drawable-v24\Screenshot_phoneOTP.png" width="300">

# Profile Screen
  This is how the page will look after login. All the details of user will  be visible here like email, name, mobile nuber. User Can add a profile picture also.
